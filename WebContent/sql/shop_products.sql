...
insert into kurly_product
	values('2', '게살.jpg', '2900', 'PET 나 게살 좋아해 스틱','1팩','상온/종이포장','택배배송은 에코포장이 스티로폼으로 대체됩니다.','샛별배송/택배배송', '100', '290', '반려동물', '고양이간식','조공','','게살_상품설명.jpg', sysdate,'특별한 기회로 만나보는 홍게 간식','게살_상세정보.jpg');